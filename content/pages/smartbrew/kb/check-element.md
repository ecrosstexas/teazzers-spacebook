...
6. To check for a “Short-to-Ground”, place one test lead on either terminal of the heater element and the other on the tank lid (See Figure 16). If there are all zero’s across the display, the element has a “Short-to-Ground” and the [heater element should be replaced](/pdf/757524-heater-element-replacement.pdf). [Resolved heating issues?](/smartbrew/kb/resolutions#307) ☺️
7. If there are no zero’s across the display, the heater element has an “Open-Short” and the [heater element should be replaced](/pdf/757524-heater-element-replacement.pdf). [Resolved heating issues?](/smartbrew/kb/resolutions#307) ☺️
8. Once the heater element has been removed, inspect the element for water scale, pin holes, etc.
9. Replace element if necessary. [Resolved heating issues?](/smartbrew/kb/resolutions#307) ☺️
